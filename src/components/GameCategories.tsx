        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
          {games.map((game) => (
            <div
              ...
              className="group relative bg-gray-800 rounded-xl p-4 hover:bg-gray-700 transition-all duration-300 cursor-pointer border border-gray-700 hover:border-purple-500/50 hover:scale-105"
            >
